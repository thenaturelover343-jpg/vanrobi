...
export const generalFaqs: FaqItem[] = [
 ...
 answer:
 "Ja. VanRobi is specialist in professionele bierkoelers (ijsbankkoelers) en kegkoelers voor België en Nederland. U koopt via een erkend kanaal, met correcte specs, garantieopvolging en lokale support.",
 },
 {
 ...
 answer:
 "Levertijden hangen af van model en voorraad in het assortiment. Reken indicatief op enkele weken voor standaardunits; portable- en specials kunnen langer duren. We bevestigen een realistische planning bij elke offerte, geen beloftes die we niet kunnen houden.",
 },
 {
 ...
 answer:
 "Ja. VanRobi bedient België én Nederland als leverancier van ijsbankkoelers. Neem contact op voor levering, advies en opvolging in uw regio.",
 },
 {
 question: "Kan ik een machine voor festivals of events huren of kopen?",
 answer:
 "We focussen op verkoop van professionele ijsbankkoelers (o.a. Goldy, V100 portable, V200 portable). Voor events helpen we met de juiste mobiele unit en opbouwadvies. Huurvragen bekijken we case by case, mail info@vanrobi.be.",
 },
 {
 question: "Wat is het verschil tussen een ijsbankkoeler en een doorstroomkoeler?",
 answer:
 'Een ijsbankkoeler houdt een ijsreserve in een waterbad aan, dat geeft buffer bij pieken. Een doorstroomkoeler koelt vooral terwijl er getapt wordt en is vaak compacter, maar heeft minder reserve. Welke beter is, hangt af van piekvolume, leidingen en ruimte. Lees onze gids "Wat is een ijsbankkoeler?" of vraag advies via info@vanrobi.be.',
 },
 {
...
export const productFaqs: Record<string, FaqItem[]> = {
 ...
 answer:
 "Ja, er zijn horizontale varianten in ons assortiment. VanRobi helpt bij de juiste keuze op basis van barmeubel en diepte.",
 },
 ],
 v200: [
 {
 ...
 answer:
 "De Picky is de kleinste over-bar ijsbankkoeler in het VanRobi-assortiment — ideaal voor foodtrucks, pop-ups en compacte craftbars waar elke centimeter telt.",
 },
 {
