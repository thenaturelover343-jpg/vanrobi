...
export default function FaqPage() {
 ...
 lede="Professioneel VanRobi-kanaal, onderhoud via Taponderhoud, eerlijke levertijden. Staat uw vraag er niet bij, mail info@vanrobi.be."
 />
