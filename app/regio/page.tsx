...
const regions = [
 ...
 {
 name: "Brussel",
 text: "Tweetalige horeca en events in Brussel. FR-hub beschikbaar (/fr/); NL-catalogus volledig. Professioneel VanRobi-kanaal, geen grijze import.",
 },
 {
...
const regioFaqs = [
 ...
 answer:
 "Ja. VanRobi adviseert en levert professionele ijsbankkoelers in Vlaanderen en Brussel, met basis in Kasterlee (Tielen). Regiodekking via Antwerpen, Limburg, Vlaams-Brabant, Brussel en Oost-Vlaanderen, plus projecten elders op aanvraag.",
 },
 {
 question: "Werken jullie ook in Nederland?",
 answer:
 "Ja. VanRobi is het erkende VanRobi-kanaal voor Nederland én België. Levering en advies landelijk.",
 },
 {
