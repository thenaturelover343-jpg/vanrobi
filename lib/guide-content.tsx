...
export function GuideBody({ slug }: { slug: string }): ReactNode {
      ...
      <section className="page-section">
        <div className="wrap guide-body">
          <Reveal className="prose guide-prose">
            ...
            <h2>Welke Golderos-modellen?</h2>
            <p>
              Via VanRobi (officiële distributeur BE &amp; NL) kiest u o.a.:
            </p>
            <ul className="guide-list">
              <li>
  ...
  if (slug === "golderos-distributeur-belgie-nederland") {
    return (
      <section className="page-section">
        <div className="wrap guide-body">
          <Reveal className="prose guide-prose">
            <h2>Officiële Golderos-distributeur BE &amp; NL</h2>
            <p>
            ...
            <ul className="guide-list">
              <li>Assortiment rechtstreeks uit de Golderos-lijn (Spanje)</li>
          ...
          <GuideAside
            ...
            links={[
              ...
              { href: "/gids/golderos-vs-gamko/", label: "Golderos vs Gamko" },
              { href: "/producten/", label: "Catalogus" },
            ]}
          />
        </div>
        ...
        <div className="wrap guide-body">
          <Reveal className="prose guide-prose">
            ...
            <ul className="guide-list">
              ...
              <li>Debiet: ± 87 L/u</li>
              <li>IJsreserve: ± 19 kg · Cuba ± 40 L</li>
            ...
            <ul className="guide-list">
              ...
              <li>IJsreserve: ± 38 kg · Cuba ± 66 L</li>
