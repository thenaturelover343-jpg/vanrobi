...
function orgCore() {
 ...
 description:
 "VanRobi: specialist in professionele ijsbankkoelers en bierkoelers voor horeca en events in België en Nederland.",
 address: {
 "@type": "PostalAddress",
...
export function websiteSchema() {
 ...
 description:
 "VanRobi: ijsbankkoelers en bierkoelers voor horeca en events in België en Nederland.",
