...
export const guides: Guide[] = [
 ...
 title: "Ijsbankkoeler vs Gamko: wat past bij uw bar?",
 eyebrow: "Vergelijking",
 description:
 "Vergelijk Professionele ijsbankkoelers via VanRobi met Gamko-achtige oplossingen: focus, onderhoud en wanneer VanRobi de betere match is voor BE/NL horeca.",
 lede: "Twee namen die vaak vallen bij bierkoeling. Wij zetten de praktische verschillen op een rij, vanuit het perspectief van een specialist in ijsbankkoelers voor BE/NL.",
 updated: "2026-09-19",
