...
export const frHome = {
 ...
 titleEm: "du service",
 lede:
 "VanRobi est le spécialiste des refroidisseurs à banquise pour la Belgique et les Pays-Bas. Refroidisseurs à banc de glace pour Horeca, events et installateurs.",
...
export const frServices = {
 ...
 lede:
 "VanRobi livre et conseille les refroidisseurs VanRobi. Maintenance, nettoyage et réparations via Taponderhoud, une équipe locale.",
 items: [
 {
 n: "01",
 title: "Conseil & sélection",
 text: "Quelle ijsbankkoeler pour votre bar, event ou brasserie ? Nous alignons volume, espace, spirales et débit, sans discours commercial.",
 },
 {
 n: "02",
...
export const frFaq = {
 ...
 {
 question:
 "VanRobi est-il le spécialiste des refroidisseurs à banquise pour la BE et les NL ?",
 answer:
